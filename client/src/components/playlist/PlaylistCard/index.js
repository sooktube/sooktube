...
function PlaylistCard() {
    const card = {
        listName: "재생목록 제목이 조금 더 더 길 수도 있습니다 적당히길",
        listLike: 7,
        listDesc:
"그들의 품으며, 새 그러므로 용기가 열매를 속에서 현저하게 쓸쓸하랴? 고동을 쓸쓸한 인생을 끓는다. 소담스러운 끓는 두손을 위하여, 싶이 그러므로 이것이다. 있는 관현악이며, 찬미를 천하를 살았으며, 동산에는 따뜻한 새 보라. 그것은 따뜻한 이상의 있는 그들은 현저하게"
        ,
        username: "jua0610",
